...
echo '<form name="form2" action="reporte.php" method="POST" target="_top">
<table border=1 style="position:absolute; overflow:hidden; left:520px; top:240px; width:500px; height:40px; z-index:36">
...
$loc=$_REQUEST['loc'];
$consul=mysql_query("select * from producto where descripcion like '$loc'");
...
$resul=mysql_query("select * from factura, detalle  where detalle.producto=productos.codigo and detalle.producto like '$cod' limit $comienzo, $num",$link);

}else{
$resul=mysql_query("select * from factura limit $comienzo, $num",$link);
}
while($fila=mysql_fetch_array($resul)){
echo '<tr bgcolor=coffe><td>'.$fila['0'].'</td><td>'.$fila['2'].'</td><td>'.$fila['6'].'</td><td>'.$fila['7'].'</td>';
...
<form name="form1" target="_top" method="POST" action="reporte.php" style="margin:0px">
...
<input name="loc" value="<?php echo $loc ?>" placeholder="Digite el producto a buscar" type="text" style="position:absolute;width:537px;left:489px;top:185px;z-index:25">
</form>
...
<div id="shape4" style="position:absolute; overflow:hidden; left:425px; top:142px; width:708px; height:530px; z-index:21"><img border=0 width="100%" height="100%" alt="" src="images/shape19895197.gif"></div>

<div id="text7" style="position:absolute; overflow:hidden; left:545px; top:85px; width:448px; height:45px; z-index:22">
<div class="wpmd">
<div><font face="Vani" class="ws20">Reporte de Ventas por Producto</font></div>
</div></div>

<div id="text8" style="position:absolute; overflow:hidden; left:195px; top:129px; width:98px; height:38px; z-index:23">
<div class="wpmd">
<div><font face="Vani" class="ws18">Reporte</font></div>
</div></div>

<div id="text9" style="position:absolute; overflow:hidden; left:489px; top:156px; width:441px; height:29px; z-index:24">
<div class="wpmd">
<div><font face="Vani" class="ws16">Localizador de Productos:</font></div>
</div></div>
